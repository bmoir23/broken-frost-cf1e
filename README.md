...
```
npm create cloudflare@latest -- --template=cloudflare/templates/cf-agent
```

A live public deployment of this template is available at [https://cf-agent.templates.workers.dev](https://cf-agent.templates.workers.dev)
